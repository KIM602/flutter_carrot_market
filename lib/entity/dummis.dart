...
final product2 = Product(user1, "갤럭시", 1700000, ProductStatus.normal,
    [picSum(500), picSum(501), picSum(502), picSum(503)]);

final product3 = Product(user1, '스마트 티비', 2000, ProductStatus.normal,
    [picSum(800), picSum(801), picSum(802), picSum(803)]);
